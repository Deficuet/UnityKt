...
internal class VectorType(private val componentType: ScalarType, val componentCount: Int): Type() {
    override fun toString(): String {
...
internal class MatrixType(private val columnType: VectorType, private val columnCount: Int): Type() {
    val rowCount by columnType::componentCount
    override fun toString(): String {
...
internal class StructType(private val memberTypes: List<Type>): Type() {
...
internal class PipeStorage : Type()

internal class NamedBarrier : Type()