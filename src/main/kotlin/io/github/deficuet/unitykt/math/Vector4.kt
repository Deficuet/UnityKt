...
data class Vector4(val x: Float, val y: Float, val z: Float, val w: Float): Vector<Vector4> {
    ...
    override val unit: Vector4
        get() {
            val l2 = length2
            return if (l2 > Vector.ERROR_MARGIN) {
                with(1 / sqrt(l2)) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return minus(other.cast()).length2 < Vector.ERROR_MARGIN
    }
